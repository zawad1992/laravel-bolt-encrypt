...
/**
 * Bootstrap file for Laravel Bolt Encrypt
 * This file must be loaded before any encrypted files are executed
 */
...
if (!function_exists('bolt_decrypt')) {
    ...
    function bolt_decrypt(string $file, string $key): void
    {
        ...
        if ($pos === false) {
            throw new Exception("Invalid encrypted file format in: $file");
        }
